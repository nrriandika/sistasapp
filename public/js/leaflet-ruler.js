(function(factory, window){
  ...
  L.Control.Ruler = L.Control.extend({
    ...
    onAdd: function(map) {
      this._map = map;
      // this._container = L.DomUtil.create('button', 'btn btn-outline-big btn-sm btn-map-tool');
      // this._container.type = 'button';
      // this._container.title = 'Pengukuran Jarak';
      // this._container.innerHTML   = '<i class="icofont icofont-ruler-compass"></i>';
      //this._container.classList.add('leaflet-ruler');
      this._container = document.getElementById('btn-measure-distance');
